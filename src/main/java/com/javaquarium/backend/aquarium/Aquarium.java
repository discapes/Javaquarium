...
public class Aquarium {
     ...
     * */
    public Aquarium(String string) throws InvalidAquariumFileException {
        ...
        try {
            ...
            throw new InvalidAquariumFileException(e);
        }
    ...
    public void restartClock() {
        ...
        if (Settings.tickRate > 0) timer.scheduleAtFixedRate(clockTask, Settings.tickRate, Settings.tickRate);
    }
